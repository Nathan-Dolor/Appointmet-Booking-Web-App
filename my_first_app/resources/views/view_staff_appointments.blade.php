...
<div class="mt-3 vh-100">
    <div class="row w-50 mx-auto">
        ...
        @foreach($appointments as $appointment)
            @if(auth()->user()->id == $appointment->staff_id)
    ...
    <div class="accordion w-50 mx-auto" id="accordion{{$appointment->id}}" >
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-body">
                @foreach($users as $user)
                    @if($appointment->member_email == $user->email)
                ...
                <a href="{{ route('viewStaffAppointments') }}" 
        ...
        <form id="delete-form-{{$appointment->id}}" 
            + action="{{route('staffAppointment.destroy', $appointment->id)}}"
            method="post">
            @csrf @method('DELETE')
        </form>
        @endif
